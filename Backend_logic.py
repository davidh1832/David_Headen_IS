...
def refine_response_with_gpt(user_input: str, user_id: str):
    return chatbot_instance.refine_response_with_gpt(user_input, user_id)

def recommend_quotes(user_input: str, source: str):
    return chatbot_instance.recommend_Quotes(user_input, source)
# Run:
# cd Desktop
# cd Chatbot
